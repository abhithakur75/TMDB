...
//  --url 'https://api.themoviedb.org/3/movie/11?api_key=191c99c3810edc08259371af1c40a35c'
   ...
   return (
      <>
         <div className="container">
            <h1 className=" topmovie-heading"> <b> Popular Movies </b> <i className="fa-solid fa-chevron-right"></i>  </h1>
            <div className="row">
               {
                  data.map((movie_data) => {
                     return (
